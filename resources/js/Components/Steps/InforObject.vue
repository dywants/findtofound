<template>
    <article>
        ...
        <div class="mb-6">
            <label for="piece_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Nature de
                l'objet</label>
        ...
        <div class="mb-6">
            <label for="findCity" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ville où la
                pièce est trouvée</label>
        ...
        <div class="mb-6">
            <label for="ward" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Quartier</label>
            <Field type="text" id="ward" name="ward"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " />
            <ErrorMessage name="ward" class="mt-2 text-sm text-red-600" />
        </div>
        <div class="mb-6">
            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="photos">Upload image
                pièce perdué</label>
            <Field
                ...
                ref="photos" name="photos" type="file" enctype="multipart/form-data" multiple accept="image/*"
                @change="onFileChange" />
        ...
        <div class="mb-6">
            <label for="details" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Details
                supplementaire</label>

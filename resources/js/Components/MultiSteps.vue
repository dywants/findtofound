...
<script>
import Information from './Steps/YourInformation.vue';
import Object from './Steps/InforObject.vue';
import Complement from './Steps/Validation.vue';
export default {
    name: 'MultiSteps',
    data () {
        return {

        ...
        <form>
            <div class="relative w-full">
                    <input type="search"
                           ...
                           v-model="term"
                           id="search"
                           class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Entrez votre nom " required="">
                ...
                <Link :href="result.item.link" @mousedown.prevent>
                    <div class="mx-auto flex flex-wrap cursor-pointer hover:bg-orange-50 mb-2 p-4 rounded-sm border">
                        ...
                        <div class="md:w-1/2 border w-full md:pl-10 md:py-6 mt-6 md:mt-0 p-4">
                            <h2 class="text-gray-900 text-3xl title-font font-medium mb-1" style="cursor: auto;">{{ result.item.fullName }}</h2>

<template>
    <AdminLayout>
        <div class="dashboard-container">
            ...
            <!-- Formulaire de création de devise -->
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-options">
                            ...
                            <div class="checkbox-group">
                                ...
                                <div class="help-text default-help">Si vous définissez cette devise comme devise par défaut, toutes les autres devises perdront ce statut.</div>
                            </div>
                        </div>
                    </div>

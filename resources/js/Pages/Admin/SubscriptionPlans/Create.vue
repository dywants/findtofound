        ...
        <div class="dashboard-container">
            <div class="header-section">
                <div class="title-container">
                    ...
                    <h1 class="page-title">Ajouter un plan d'abonnement</h1>
                </div>
...
// Variables pour les options de type case à cocher
const documentTypes = ref(['pdf']); // Par défaut, PDF est sélectionné
const watermarkOptions = ref(['text']); // Par défaut, texte est sélectionné
const isUnlimitedDocuments = ref(false); // Option pour documents illimités

// Initialiser le formulaire avec une structure pour les fonctionnalités
const form = useForm({
    name: '',
    slug: '',
    description: '',
    ...
    features: {
        ...
        document_types: [], // sera mis à jour par watch
        watermark_options: [], // sera mis à jour par watch
        storage_duration: 7,
        max_shares: 3,
...
const submit = () => {
    // S'assurer que features est envoyé comme JSON

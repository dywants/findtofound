            ...
            <div class="card-content">
                        ...
                        <td class="actions-cell">
                            <div class="buttons right nowrap">
                                <Link :href="route('faq.edit', {faq: faq.id})"
                                      class="button small green --jb-modal"  data-target="sample-modal-2" type="button">
                                  <span class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                ...
                                <a href="javascript:void(0)" @click.prevent="deleteFaq(faq.id)"  class="button small red --jb-modal" data-target="sample-modal" type="button">
                                   <span class="icon">
                ...
                <div class="table-pagination">
                    <div class="flex items-center justify-between">
                        <ul class="buttons">
                            <li :class="faqs.links[0].url == null ? ' active' : 'disabled'" :disabled="faqs.links[0].url == null "
                                    class="button" >
                                <Link :href="faqs.links[0].url == null ? '#' : faqs.links[0].url" v-html="faqs.links[0].label" />
                            </li>
                            ...
                            <li :class="faqs.links[faqs.links.length - 1].url == null ? ' active' : ' disabled'" class="button">
                                <Link :href="faqs.links[faqs.links.length - 1].url == null ? '#' : faqs.links[faqs.links.length - 1].url"  v-html="faqs.links[faqs.links.length - 1].label" />
                            </li>
                        </ul>

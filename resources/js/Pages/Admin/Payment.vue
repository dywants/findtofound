        ...
        <div class="card-content">
            <table>
                ...
                <tr v-for="payment in payments" :key="payment.id">
                    ...
                    <td data-label="Name">{{ payment.type_piece }}</td>
                    <td data-label="Company">{{ payment.user_payer.name }}</td>
                    <td data-label="City">{{ payment.amount }}</td>
                    <td data-label="City">{{ payment.currency }}</td>
                    <td data-label="City">{{ payment.paymentSource }}</td>

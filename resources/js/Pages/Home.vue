            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                <div class="w-full md:w-1/2 space-y-6">
                    ...
                    <div class="prose prose-lg text-gray-600 animate-fade-in-up delay-100">
                        <p class="text-lg">
                            <span class="font-bold">Docu<span class="text-blue-600">Trace</span></span> est votre solution complète pour la gestion de documents. Protégez vos pièces avec des filigranes sécurisés et retrouvez facilement vos documents égarés.
                        </p>
                        <p class="mt-4">
                            Double protection : Sécurisez vos documents sensibles avec des filigranes professionnels et bénéficiez de notre système de recherche efficace en cas de perte.
                        </p>
                    </div>
                ...
                <div class="w-full md:w-1/2 animate-fade-in-up delay-300">
                    <div class="relative">
                        <div class="absolute inset-0 bg-blue-200 rounded-full filter blur-3xl opacity-20 transform rotate-12"></div>
                        <img class="relative rounded-2xl shadow-2xl transform hover:scale-105 transition-transform duration-300" alt="hero" src="images/pieces.png">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3">
                    <div class="p-6 bg-white rounded-lg shadow-lg">
                        <img src="/images/services/protection.svg" alt="Protection de documents" class="w-16 h-16 mx-auto mb-4">
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Protection de Documents</h3>
                        <p class="text-gray-600">Sécurisez vos documents importants avec notre système de filigrane personnalisé.</p>
                    </div>

                    <div class="p-6 bg-white rounded-lg shadow-lg">
                        <img src="/images/services/search.svg" alt="Recherche efficace" class="w-16 h-16 mx-auto mb-4">
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Recherche Efficace</h3>
                        <p class="text-gray-600">Retrouvez rapidement vos documents perdus grâce à notre système de recherche avancé.</p>
                    </div>

                    <div class="p-6 bg-white rounded-lg shadow-lg">
                        <img src="/images/services/connect.svg" alt="Mise en relation" class="w-16 h-16 mx-auto mb-4">
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Mise en Relation Sécurisée</h3>
                        <p class="text-gray-600">Connectez-vous en toute sécurité avec les personnes qui ont trouvé vos documents.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div v-for="testimonial in testimonials" :key="testimonial.id" 
                        ...
                        <div class="flex items-center mb-4">
                            <div :class="testimonial.bgColor" class="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold">
                ...
                <div class="max-w-3xl mx-auto">
                    <div v-for="faq in faqs" :key="faq.id" class="mb-8">
                        ...
                        <div v-show="faq.isOpen" 
                             class="mt-4 text-gray-600 p-4 bg-white rounded-lg shadow-inner">
                            {{ faq.answer }}
                        </div>
                    </div>
                </div>
